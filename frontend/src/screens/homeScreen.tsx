      ...
      <View style={globalStyles.fullWidth}>
        <View style={styles.section}>
          ...
          {eventList.map((item, key) => (
            <View key={key}>
              <Text style={[styles.basicText, globalStyles.primaryText]}>
                {item}
              </Text>
              <Icon
        ...
        <View style={styles.section}>
          <View style={styles.newBtns}>
            <Button
              ...
              onPress={() => navigation.navigate("New Metrics")}
            ></Button>
          </View>
    ...
    <View style={globalStyles.container}>
      <View style={styles.section}>
        {isEditUsername ? (
          <View style={styles.usernameContainer}>
            ...
            <Icon
              ...
              size={24}
              color="black"
              onPress={() => changeUsername(usernameText)}
            ></Icon>
          </View>
        ) : (
          <View style={styles.usernameContainer}>
            ...
            <Icon
              ...
              size={24}
              color="black"
              onPress={() => setIsEditUsername(true)}
            ></Icon>
          </View>
        )}
        ...
        <View style={styles.toggleServerContainer}>
          ...
          <Switch
            disabled={false}
            style={styles.serverSwitch}
            value={isServer}
            onValueChange={(value) => serverToggled(value)}
          ></Switch>
        </View>
      </View>
